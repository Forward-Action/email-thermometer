...
imagettftext($image, 22, 0, ($x - 17), 55, $primary, $font_bold, $goal);
...
$zero_label = '0%';
imagettftext($image, 16, 0, 15, 126, $label, $font_semi, $zero_label);

$hund_label = '100%';
imagettftext($image, 16, 0, 553, 126, $label, $font_semi, $hund_label);
